...
export default function SellerProductsPage() {
  ...
  if (isLoading) return <div className="p-12 text-center text-lg">Loading Products...</div>;
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">Manage the products you sell to the public.</p>
      </div>
      ...
      {!store ? (
        <Card className="bg-slate-50 border-dashed">
          <CardContent className="flex flex-col items-center justify-center h-64 text-center">
            ...
            <p className="text-sm text-slate-400">Go to My Profile and fill out the store form to get started.</p>
          </CardContent>
        </Card>
      ) : (
        <div className="space-y-8">
