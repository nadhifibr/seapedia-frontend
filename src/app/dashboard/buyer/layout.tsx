...
export default function BuyerDashboardLayout({
  ...
  const accountLinks = [
    { name: 'Profile', href: '/dashboard/buyer' },
    { name: 'Wallet', href: '/dashboard/buyer/wallet' },
    { name: 'Addresses', href: '/dashboard/buyer/addresses' },
  ];

  const orderLinks = [
    { name: 'Order', href: '/dashboard/buyer/orders' },
  ];
